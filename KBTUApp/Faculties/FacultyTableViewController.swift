...
class FacultyTableViewController: UITableViewController {
    ...
    var faculties = [
        Faculty(title: "Engineering & Natural Sciences", imageofFaculties: UIImage.init(named:"Engineers")!, tagline: "Learn with the best in IT among us", facultiesPhoto: UIImage.init(named: "Math")!)
    ]
